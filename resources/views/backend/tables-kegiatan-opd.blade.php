          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between mb-3 mt-3">
                <a href="{{ route('backend.forms-tambahkegiatan-opd') }}" class="btn btn-primary ms-auto">Tambah Kegiatan</a>
              </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  @foreach($kegiatanOpd as $kegiatanOpd)
                  <tr>
                      <td>{{ $kegiatanOpd->judul_kegiatan }}</td>
                      <td class="text-center">{{ $kegiatanOpd->tanggal }}</td>
                      <td class="text-center">
                        <a href="{{ route('kegiatanopd.edit', $kegiatanOpd->id) }}" class="btn btn-warning d-inline-block mr-2">Edit</a>
                        <form action="{{ route('kegiatanopd.destroy', $kegiatanOpd->id) }}" method="POST" class="d-inline-block">
                            @csrf
                            @method('DELETE') 
