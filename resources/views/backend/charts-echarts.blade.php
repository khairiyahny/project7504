...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ url('backend')}}" class="logo d-flex align-items-center">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ url('backend/charts-echarts')}}" class="active">
  ...
  <main id="main" class="main">
    ...
    <p>ECharts Examples. You can check the <a href="{{ url('backend/https://echarts.apache.org/examples/en/index-backend')}}" target="_blank">official website</a> for more examples.</p>
