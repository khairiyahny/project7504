    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ url('backend/components-cards')}}" class="active">
      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
          ...
          <div class="card mb-3">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="{{asset('assets-backend/img/card.jpg')}}" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col-lg-3">
          ...
          <div class="card">
            <img src="{{asset('assets-backend/img/card.jpg')}}" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            ...
            <img src="{{asset('assets-backend/img/card.jpg')}}" class="card-img-bottom" alt="...">
