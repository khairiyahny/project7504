...
<body>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('assets')}}" alt="" class="rounded-circle">
                <div>
                  <h4>Maria Hudson</h4>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ url('backend')}}">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="{{ url('backend/components-carousel')}}" class="active">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="{{asset('assets-backend/img/slides-1.jpg')}}" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('assets-backend/img/slides-2.jpg')}}" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('assets-backend/img/slides-3.jpg')}}" class="d-block w-100" alt="...">
                  </div>
                </div>
