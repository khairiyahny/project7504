...
<body>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                href="{{ url('backend/users-profile') }}">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#statsek-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-building"></i><span>Statistik Sektoral</span><i
            ...
            <li class="nav-item border-top mt-2 pt-2">
                <a class="nav-link collapsed" data-bs-target="#templates-nav" data-bs-toggle="collapse"
                    href="#">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('backend/index-backend') }}">Home</a></li>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets-backend/img/product-1.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets-backend/img/product-2.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets-backend/img/product-3.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets-backend/img/product-4.jpg') }}"
                                                            alt=""></a></th>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#"><img
                                                            src="{{ asset('assets-backend/img/product-5.jpg') }}"
                                                            alt=""></a></th>
